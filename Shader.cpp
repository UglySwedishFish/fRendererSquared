...
unsigned int fRenderer::Rendering::Core::LoadShader(unsigned int ShaderType, const char * File)
{
...
fRenderer::Rendering::Core::Shader::Shader(const char * vertex, const char * fragment) :
...
fRenderer::Rendering::Core::Shader::Shader() : 
	VertexShader(NULL),
	FragmentShader(NULL),
	ShaderID(NULL)
{
...
void fRenderer::Rendering::Core::Shader::Bind()
{
	glUseProgram(ShaderID); 
}

void fRenderer::Rendering::Core::Shader::UnBind()
{
	glUseProgram(NULL); 
}
